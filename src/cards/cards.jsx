    ...
    <StyledWrapper>
      <div className="card flex flex-col justify-center items-center">
        ...
        <div className="card-footer">
          ...
          <div className="group card-button hover:bg-red-800 hover:text-red-200 hover:border-red-200 hover:border-2">
            <svg className="group-hover:fill-red-200" viewBox="0 0 20 20">
